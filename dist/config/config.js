...
exports.config = {
    ...
    MONGODB_URL: process.env.MONGODB_URL || 'mongodb://localhost/alyataxi',
    ROOT_EMAIL: process.env.ROOT_EMAIL || 'oleksandr.naumyk@gmail.com',
    ROOT_EMAIL_PASSWORD: process.env.ROOT_EMAIL_PASSWORD || 'Na1980!@',
    ROOT_EMAIL_SERVICE: process.env.ROOT_EMAIL_SERVICE || 'gmail',
    SUPPORT_EMAIL: process.env.SUPPORT_EMAIL || 'oleksandr.naumyk@gmail.com'
};
